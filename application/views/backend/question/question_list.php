<ol class="breadcrumb">
    <li class="active">
        <i class="fa fa-dashboard"></i> <a href="<?php echo $url_admin?>">Dashboard</a> / <a href="<?php echo $url_admin?>app">App</a> / Câu hỏi 
    </li>
</ol>
<div class="well">
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="<?php echo $url_admin?>question/<?php echo $app_id;?>">
            ...
            <form method="post" action="<?php echo $url_admin?>question">
                <p class="input-group-btn">
        ...
        <div class="col-lg-12">
        	<div id="add" style="margin-bottom:5px;"><a href="<?php echo $url_admin;?>question/form/<?php echo $app_id;?>" class="btn btn-success">Thêm mới</a></div>
            ...
            <form action="" method="post">
                <table align="center" class="table table-bordered table-hover table-striped" width="100%">
                        <tr>
                            ...
                            <td width="467" align="center" style="font-weight: bold">Câu hỏi</td>
                            <td width="333" align="center" style="font-weight: bold">Câu trả lời</td>
                        ...
                        <tr <?php if(($i%2==0)) echo "class='success'"; else echo "class='danger'";  ?>>
                            ...
                            <td align="center"  class="status"><a href="<?php echo $url_admin;?>answer/<?php echo $item->id;?>"><span class="label label-primary ">Danh sách câu trả lời</span></a></td>
                            ...
                            <td width="41">
                                 <a href="<?php echo $url_admin;?>question/form/<?php echo $item->app_id;?>/<?php echo $item->id;?>">
                                <span class="label label-info"> Sửa </span></a>       
                            </td>
                            <td width="62">
                            	<a href="<?php echo $url_admin;?>question/del/<?php echo $item->app_id;?>/<?php echo $item->id;?>" onClick="return confirm('Bạn có chắc muốn xóa không ?')" ><span class="label label-danger">Xóa</span></a> 
                            </td>
                        </tr>
                        <?php
							}
